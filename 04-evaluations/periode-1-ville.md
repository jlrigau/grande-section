# Évaluations Période 1 — 🏙️ La ville (mi-octobre 2026)

Passation en ateliers de 4-6 élèves (sauf mention « individuel »), intégrée aux activités. Codage : **A / EC / NE** (voir mode d'emploi).

---

## Fiche 1.1 — Vocabulaire : les mots de la ville *(individuel, 5-8 min)*
...
## Fiche 1.2 — Langage oral : raconter la sortie au quartier *(individuel, 5 min, enregistrable)*
...
## Fiche 1.3 — Phonologie : les immeubles à syllabes *(groupe de 4, 10 min)*
...
## Fiche 1.4 — Lettres : l'abécédaire de la classe *(individuel, 5 min)*
...
## Fiche 1.5 — Écriture : tracés et capitales *(groupe de 6, sur fiche)*
...
## Fiche 1.7 — Nombres : le parking *(atelier manipulation, individuel dans le groupe)*
...
## Fiche 1.8 — Décompositions : le greli-grelo des pigeons *(groupe de 4)*
...
## Fiche 1.9 — Formes planes : les façades *(groupe de 6, manipulation + fiche trace)*
...
## Fiche 1.10 — Motifs : la guirlande de fanions *(individuel dans l'atelier)*
...
## Fiche 1.11 — Espace : la maquette du quartier *(groupe de 4)*
...
## Fiche 1.12 — Le vivant : notre élevage d'escargots *(individuel, oral + dessin)*
...
## Fiche 1.13 — Temps : ma journée d'école *(groupe de 4)*
...
## Grilles d'observation en situation (à renseigner sur les semaines 5-7)

### G1.A — EPS (unités « traverser la ville » et « explorateurs »)
| Élève | Court vite sans s'arrêter dans son couloir | Réagit au signal | Retrouve ≥ 5 éléments sur photos dans l'école | Respecte les règles de jeu | Code |
|---|---|---|---|---|---|

### G1.B — Arts (fresque, chant, paysage sonore)
| Élève | Participe à la fresque avec intention | Tient sa place dans le chant collectif (2 chants) | Reconnaît des sons de la ville et les reproduit | Commente sa production | Code |
|---|---|---|---|---|---|

### G1.C — Langage oral en situation (continu)
| Élève | Prend la parole en regroupement | Se fait comprendre | Emploie les mots des corpus | Articule (paires t/k, f/s) | Code |
|---|---|---|---|---|---|

### G1.D — EVAR / devenir élève (dont séance spécifique n°1)
| Élève | Nomme son émotion (météo des émotions) | Reconnaît l'émotion d'un camarade/personnage | Connaît un adulte de confiance à l'école | Respecte les règles co-construites | Code |
|---|---|---|---|---|---|

---

## Récapitulatif Période 1 (à agrafer au dossier de l'élève)

| Fiche/Grille | Compétence-clé | Code | Observations |
|---|---|---|---|
| 1.1 | Vocabulaire ville | | |
| 1.2 | Récit d'expérience vécue | | |
| 1.3 | Syllabes | | |
| 1.4 | Lettres/prénom | | |
| 1.5 | Geste graphique/copie | | |
| 1.6 | Compréhension d'album | | |
| 1.7 | Nombres jusqu'à 6 | | |
| 1.8 | Décompositions ≤ 5 | | |
| 1.9 | Formes planes | | |
| 1.10 | Motifs répétitifs | | |
| 1.11 | Maquette/plan | | |
| 1.12 | Morphologie/besoins de l'escargot | | |
| 1.13 | Chronologie/semaine | | |
| G1.A-D | EPS / Arts / Oral / EVAR | | |
