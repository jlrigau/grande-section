# Évaluations Période 5 — 🌊 La mer (juin 2027) — bilan de fin de GS

Cette batterie sert au **bilan de fin d'école maternelle** : elle alimente la synthèse des acquis et la liaison GS-CP. Passation étalée sur 3 semaines de juin, en ateliers ou individuellement. Codage : **A / EC / NE**.

---

## Fiche 5.1 — Vocabulaire : le tour des cinq milieux *(individuel, 10 min)*
...
## Fiche 5.4 — Lettres : l'alphabet du corsaire *(individuel, 5 min)*
...
## Fiche 5.5 — Écriture : la carte postale *(individuel, 10 min)*
...
## Fiche 5.7 — Types d'écrits *(groupe de 4, 8 min)*
...
## Fiche 5.8 — Nombres : la grande pêche *(atelier manipulation, individuel, 10 min)*
...
## Fiche 5.10 — Formes, solides et espace : construire le port *(groupe de 4)*
...
## Fiche 5.11 — Grandeurs et motifs : le stand de la plage *(groupe de 4)*
...
## Fiche 5.12 — Temps : notre année *(groupe de 4)*
...
## Fiche 5.13 — Espace : terre et mer *(groupe de 4)*
...
## Fiche 5.14 — Le vivant : classer les animaux marins *(individuel, 8 min)*
...
## Fiche 5.15 — Matière et objets : flotte, coule… navigue ! *(groupe de 4, défi)*
...
## Grilles d'observation en situation

### G5.A — EPS (aisance aquatique ou équilibres, orientation, chorégraphie)
| Élève | Réalise le parcours aquatique de son niveau (ou parcours d'équilibre) | Retrouve 5 indices photo hors de l'école | Lance avec élan vers une cible | Danse sa partie dans la chorégraphie devant public | Observe et formule un conseil | Code |
|---|---|---|---|---|---|---|

### G5.B — Arts (bilan)
| Élève | Compose l'affiche à contraintes (3 motifs, 2 outils, à plusieurs) | Chante de mémoire sans l'adulte (répertoire ≥ 10) | Reconnaît et nomme les 3 œuvres patrimoniales de l'année | Décrit *La Grande Vague* (composition, plans) | Code |
|---|---|---|---|---|---|

### G5.C — Langage oral en situation (bilan)
| Élève | S'exprime en phrases complexes variées | Tous les phonèmes correctement articulés | Se décentre : donne les informations nécessaires à l'interlocuteur | Récite/chante les textes de l'année | Code |
|---|---|---|---|---|---|

### G5.D — EVAR (séance spécifique n°3 + bilan)
| Élève | Identifie ressemblances/différences et en parle avec respect | Décrit l'effet de ses paroles/actes sur les autres | Coopère dans les jeux collaboratifs | Exprime sereinement ce qu'il ressent à l'idée du CP | Code |
|---|---|---|---|---|---|

---

## Récapitulatif Période 5 — vers la synthèse des acquis de fin de maternelle

| Fiche/Grille | Compétence-clé | Code | Observations |
|---|---|---|---|
| 5.1 | Lexique de l'année, catégorisation, inférence | | |
| 5.2 | Discours structuré (exposé) | | |
| 5.3 | Conscience syllabique et phonémique | | |
| 5.4 | Alphabet 3 graphies + valeurs sonores | | |
| 5.5 | Cursive : copie, encodage, signature | | |
| 5.6 | Récit intégral sans support | | |
| 5.7 | Types d'écrits | | |
| 5.8 | Nombres : bilan complet | | |
| 5.9 | Problèmes : bilan | | |
| 5.10 | Solides/formes + repérage | | |
| 5.11 | Grandeurs + motifs créés | | |
| 5.12 | Temps : l'année, mois, saisons | | |
| 5.13 | Terre/mer, planisphère, plan | | |
| 5.14 | Classements du vivant | | |
| 5.15 | Flottabilité + défi bateau | | |
| G5.A-D | EPS / Arts / Oral / EVAR | | |

**Après passation** : renseigner le livret de suivi (colonne P5), rédiger la synthèse des acquis de fin d'école maternelle, préparer les documents de liaison GS-CP (corpus de mots connus, textes mémorisés, niveau d'encodage, comptine numérique, points de vigilance).
