# Évaluations Période 4 — 🌾 La campagne (avril 2027, avant les vacances de printemps)

Passation en ateliers de 4-6 élèves (sauf mention « individuel »). Codage : **A / EC / NE**.

---

## Fiche 4.1 — Vocabulaire : les mots de la ferme *(individuel, 8 min)*
...
## Fiche 4.3 — Phonologie : la ferme des sons *(groupe de 4, 10 min)*
...
## Fiche 4.4 — Lettres et épellation *(individuel, 5 min)*
...
## Fiche 4.5 — Écriture : le prénom sans modèle *(individuel, sur lignage)*
...
## Fiche 4.7 — Encodage : les étiquettes du potager *(individuel, 8 min)*
...
## Fiche 4.8 — Nombres : le marché aux œufs *(atelier manipulation, individuel)*
...
## Fiche 4.9 — Problèmes : groupements et partages *(individuel dans l'atelier)*
...
## Fiche 4.10 — Formes : tangram et tracé à la règle *(groupe de 6)*
...
## Fiche 4.11 — Grandeurs : la récolte *(groupe de 4)*
...
## Fiche 4.12 — Motifs : les rangs du potager *(individuel dans l'atelier)*
...
## Fiche 4.13 — Le vivant : les cycles de vie *(individuel, images séquentielles + oral)*
...
## Fiche 4.14 — Matière : ça se dissout ou pas ? *(groupe de 4, expérience)*
...
## Fiche 4.15 — Objets : la notice de plantation *(groupe de 4)*
...
### G4.A — EPS (sauter/franchir, jeux collectifs)
| Élève | Franchit la « rivière » (60-80 cm) sans ralentir | Saute et se réceptionne sur 2 pieds équilibré | Tient les 3 rôles (attaquant, défenseur, arbitre) | Propose/suit une stratégie d'équipe, accepte la défaite | Code |
|---|---|---|---|---|---|

### G4.B — Arts (modelage, Arcimboldo, Carnaval des animaux)
| Élève | Modèle un animal reconnaissable (boule, colombin, assemblage) | Compose « à la manière d'Arcimboldo » et explique ses choix | Associe un instrument à un animal (Carnaval des animaux) | Reconnaît les 3 œuvres patrimoniales entendues (Vivaldi ×2, Saint-Saëns) | Code |
|---|---|---|---|---|---|

### G4.C — Langage oral en situation
| Élève | Emploie futur simple/futur antérieur | Explique une démarche à un tiers | Questionne (interview du fermier) | Réemploie les corpus de la ferme | Code |
|---|---|---|---|---|---|

### G4.D — EVAR / devenir élève (fil continu)
| Élève | Prend sa part des responsabilités (semis, élevage) | Respecte le vivant | S'engage dans les activités sans stéréotype de genre (rôles, jeux) | Aide un camarade | Code |
|---|---|---|---|---|---|

---

## Récapitulatif Période 4

| Fiche/Grille | Compétence-clé | Code | Observations |
|---|---|---|---|
| 4.1 | Vocabulaire ferme + familles | | |
| 4.2 | Expliquer une démarche (futur) | | |
| 4.3 | Phonèmes fricatives | | |
| 4.4 | Épellation | | |
| 4.5 | Prénom cursive sans modèle | | |
| 4.6 | Motivations des personnages | | |
| 4.7 | Encodage autonome | | |
| 4.8 | Compléments à 10, 2 en 2 | | |
| 4.9 | Groupements et partages | | |
| 4.10 | Tangram + règle | | |
| 4.11 | Masses ordonnées, longueur produite | | |
| 4.12 | Transcription de motifs | | |
| 4.13 | Cycles de vie, besoins des plantes | | |
| 4.14 | Dissolution | | |
| 4.15 | Suite d'instructions | | |
| G4.A-D | EPS / Arts / Oral / EVAR | | |
