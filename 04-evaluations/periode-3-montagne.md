# Évaluations Période 3 — ⛰️ La montagne (février 2027, avant les vacances d'hiver)

Passation en ateliers de 4-6 élèves (sauf mention « individuel »). Codage : **A / EC / NE**.

---

## Fiche 3.1 — Vocabulaire : les mots de la montagne et des émotions *(individuel, 8 min)*
...
## Fiche 3.3 — Phonologie : attaque, rime et premiers phonèmes *(groupe de 4, 10 min)*
...
## Fiche 3.4 — Lettres : la cordée des 3 écritures *(individuel, 5 min)*
...
## Fiche 3.5 — Écriture : le prénom en cursive *(individuel, sur lignage)*
...
## Fiche 3.7 — Encodage : les mots transparents *(individuel, 5-8 min)*
...
## Fiche 3.8 — Nombres : la cordée de 10 *(atelier manipulation, individuel)*
...
## Fiche 3.9 — Bande numérique et déplacements : le télésiège *(groupe de 4, jeu de plateau)*
...
## Fiche 3.10 — Problèmes : les boules de neige *(individuel dans l'atelier)*
...
## Fiche 3.11 — Solides : le village de montagne *(groupe de 4)*
...
## Fiche 3.12 — Grandeurs : la balance du refuge *(groupe de 4)*
...
## Fiche 3.13 — Motifs : les frises de flocons *(individuel dans l'atelier)*
...
## Fiche 3.14 — Matière : les états de l'eau *(individuel, oral sur photos, 5 min)*
...
## Fiche 3.15 — Corps : le pantin articulé *(individuel, dessin + oral)*
...
### G3.A — EPS (glisser/rouler, lancer, danse)
| Élève | Se déplace et s'arrête en maîtrisant sa trajectoire (glisse) | Roule et se relève seul | Lance loin / atteint une cible à 3-4 m | Danse en miroir avec un partenaire, début et fin marqués | Code |
|---|---|---|---|---|---|

### G3.B — Arts (Vivaldi « L'hiver », graphisme, glace colorée)
| Élève | Traduit un extrait musical en dessin et le commente | Distingue lent/rapide, fort/doux à l'écoute | Réinvestit lignes brisées et cristaux dans une composition | Chante les chants d'hiver de mémoire | Code |
|---|---|---|---|---|---|

### G3.C — Langage oral en situation
| Élève | Formule des hypothèses (« je pense que… ») | Emploie le système passé (imparfait/plus-que-parfait) | Prononce les doubles consonnes (br/cr/bl/pl) | Mots des émotions employés | Code |
|---|---|---|---|---|---|

### G3.D — EVAR (séance spécifique n°2 + fil continu)
| Élève | Nomme des sentiments dans la relation (amitié, confiance) | S'engage dans le jeu de confiance (guide/guidé) | Utilise le message clair ou le coin de l'aide | Coopère dans les jeux collectifs | Code |
|---|---|---|---|---|---|

---

## Récapitulatif Période 3

| Fiche/Grille | Compétence-clé | Code | Observations |
|---|---|---|---|
| 3.1 | Vocabulaire montagne + émotions | | |
| 3.2 | Hypothèse + récit au passé | | |
| 3.3 | Phonèmes voyelles, attaque/rime | | |
| 3.4 | 3 graphies + sons des fricatives | | |
| 3.5 | Prénom en cursive (avec modèle) | | |
| 3.6 | Récit autonome *La moufle* | | |
| 3.7 | Encodage mots transparents | | |
| 3.8 | Nombres jusqu'à 10, comptine 30 | | |
| 3.9 | Bande numérique, déplacements | | |
| 3.10 | Problèmes d'écart | | |
| 3.11 | Solides | | |
| 3.12 | Masses (Roberval) | | |
| 3.13 | Motifs évolutifs | | |
| 3.14 | États de l'eau | | |
| 3.15 | Articulations / dessin en mouvement | | |
| G3.A-D | EPS / Arts / Oral / EVAR | | |
