# Évaluations Période 2 — 🌳 La forêt (mi-décembre 2026)

Passation en ateliers de 4-6 élèves (sauf mention « individuel »). Codage : **A / EC / NE**. Les compétences codées EC/NE en P1 sont réévaluées ici via les fiches équivalentes (niveau supérieur).

---

## Fiche 2.1 — Vocabulaire : les mots de la forêt *(individuel, 5-8 min)*
...
## Fiche 2.3 — Phonologie : syllabes et rimes du bois *(groupe de 4, 10 min)*
...
## Fiche 2.4 — Lettres : capitales et scriptes *(individuel, 5 min)*
...
## Fiche 2.5 — Écriture : premières cursives *(groupe de 6, sur lignage)*
...
## Fiche 2.7 — Encodage : les premières syllabes *(individuel, 5 min)*
...
## Fiche 2.8 — Nombres : les réserves de l'écureuil *(atelier manipulation)*
...
## Fiche 2.9 — Problèmes : ajout et retrait *(individuel dans l'atelier)*
...
## Fiche 2.10 — Formes/espace : l'assemblage du sapin & le code du renard *(groupe de 4)*
...
## Fiche 2.11 — Grandeurs : les bâtons de la forêt *(groupe de 4)*
...
## Fiche 2.12 — Motifs : la guirlande de Noël *(individuel dans l'atelier)*
...
## Fiche 2.13 — Le vivant : l'hiver des animaux *(groupe de 4, oral)*
...
### G2.A — EPS (courir longtemps, équilibres/grimpe, danse des feuilles)
| Élève | Court 3-4 min en limitant les arrêts | Enchaîne 3 actions au parcours (grimper, ramper, se suspendre) | Attend l'autorisation, aide à la parade | Varie vitesse/énergie en danse | Code |
|---|---|---|---|---|---|

### G2.B — Arts (land art, Vivaldi, chants)
| Élève | S'engage dans la production land art et la commente | Reconnaît « L'automne » de Vivaldi (parmi 2 extraits) | Chante les chants de la période en chœur | Utilise boucles/spirales dans ses compositions | Code |
|---|---|---|---|---|---|

### G2.C — Langage oral en situation
| Élève | Récits structurés (*d'abord/ensuite/enfin*) | Emploie imparfait/passé composé | Mots des corpus réemployés | Articule ch/s, ch/j | Code |
|---|---|---|---|---|---|

### G2.D — EVAR / devenir élève (fil continu)
| Élève | Nomme les émotions des personnages (peur, ruse, joie) | S'essaie au message clair | Coopère au parcours (guide/parade) | Code |
|---|---|---|---|---|

---

## Récapitulatif Période 2

| Fiche/Grille | Compétence-clé | Code | Observations |
|---|---|---|---|
| 2.1 | Vocabulaire forêt + contraires | | |
| 2.2 | Décrire l'action d'autrui | | |
| 2.3 | Syllabes (fusion/suppression) + rimes | | |
| 2.4 | Alphabet capitale/script + voyelles | | |
| 2.5 | Cursive e, l, i, u, t | | |
| 2.6 | Compréhension *Gruffalo* (ruse) | | |
| 2.7 | Encodage de syllabes | | |
| 2.8 | Nombres jusqu'à 8 / énumération | | |
| 2.9 | Problèmes ajout/retrait | | |
| 2.10 | Assemblages + codage quadrillage | | |
| 2.11 | Longueurs : bande témoin | | |
| 2.12 | Motifs répétitifs complexes | | |
| 2.13 | Classement animaux / hiver | | |
| 2.14 | Transformation de la matière | | |
| G2.A-D | EPS / Arts / Oral / EVAR | | |
